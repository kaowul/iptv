...
cmd_array = ['{"jsonrpc": "2.0", "method": "activate_request", "id": 11, "params": {"license_key":"%s"}}',
             ...
             '{"jsonrpc": "2.0", "method": "start_stream", "id": 14, "params": {"license_key":"%s", "config": {"id": "test_1", "feedback_dir": "~/test/1", "log_level": 6, "audio_bitrate": 92,"audio_codec": "faac", "delay_time": 0,"input": {"urls": [{"id": 170,"uri": "%s"}]},"output": {"urls": [{"id": 80,"uri": "tcp://localhost:1935"}]},"type": "encode","video_bitrate": 1700,"video_codec": "x264enc","volume": 1.0}}}',
